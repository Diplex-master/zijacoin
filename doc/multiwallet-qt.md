...
In order to support loading of multiple wallets in diplexcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is diplexcoin.cpp.
...
Changes to diplexcoin.cpp
----------------------
diplexcoin.cpp is the entry point into diplexcoin-qt, and as such, will require some minor modifications to provide hooks for
