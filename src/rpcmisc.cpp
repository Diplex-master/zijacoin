...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total diplexcoin balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zDLXsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zDLX denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zDLX denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zDLX denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zDLX denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zDLX denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zDLX denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zDLX denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zDLX denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zDLX denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in diplexcoin/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in diplexcoin/kb\n"
    ...
    obj.push_back(Pair("zDLXsupply", zpivObj));
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            ...
            "\nReturn information about the given diplexcoin address.\n"

            "\nArguments:\n"
            "1. \"diplexcoinaddress\"     (string, required) The diplexcoin address to validate\n"

            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"diplexcoinaddress\", (string) The diplexcoin address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: DLX address and we have full public key:
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
        throw runtime_error(
            ...
            "2. \"keys\"       (string, required) A json array of keys which are diplexcoin addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) diplexcoin address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"diplexcoinaddress\"  (string, required) The diplexcoin address to use for the signature.\n"
