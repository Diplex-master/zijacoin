...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("DLX Core"),
     ...
     * override -datadir in the diplexcoin.conf file in the default data directory
     * (to be consistent with diplexcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
