                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DLX Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DLX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and diplexcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DLX Core"), this);
    aboutAction->setStatusTip(tr("Show information about DLX Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DLX"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DLX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DLX addresses"));
    ...
    openAction->setStatusTip(tr("Open a DLX: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DLX Core help message to get a list with possible DLX command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DLX Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DLX network", "", count));
}
...
{
    QString strTitle = tr("DLX Core"); // default title
