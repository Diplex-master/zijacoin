...
/* DiplexCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "DLX"
#define QAPP_ORG_DOMAIN "diplex.network"
#define QAPP_APP_NAME_DEFAULT "DLX-Qt"
#define QAPP_APP_NAME_TESTNET "DLX-Qt-testnet"
