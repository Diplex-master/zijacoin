...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("DiplexCoin Core diplexcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  diplexcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded diplexcoin transaction") + "\n" +
                               "  diplexcoin-tx [options] -create [commands]   " + _("Create hex-encoded diplexcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded diplexcoin transaction
