Contributing to DLX Core
============================

The DLX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DLX Core project, and is not to be
confused with overall DLX Network Protocol consensus changes.

Whether a pull request is merged into DLX Core rests with the project merge
...
Patches that change DLX consensus rules are considerably more involved than
...
Where a patch set proposes to change the DLX consensus, it must have been
...
The project leader is the release manager for each DLX Core release.
